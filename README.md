...
this mod includes the restored & improved rhythm game editor in DELTARUNE Chapter 4 and the custom "Black Knife" & "The Third Sanctuary" chart.
made with The Underminers' [UndertaleModTool](https://github.com/UnderminersTeam/UndertaleModTool).
